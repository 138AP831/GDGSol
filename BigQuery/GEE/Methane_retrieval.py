...
# Sentinel-5P CO and Methane image collections
...
# Function to extract monthly CO and Methane data at a given point
...
def handle_click(**kwargs):
    if kwargs.get('lat') and kwargs.get('lng'):
        ...
        # Fetch CO and Methane data for the selected point
